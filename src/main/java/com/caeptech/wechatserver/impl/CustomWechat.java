package com.caeptech.wechatserver.impl;



import com.caeptech.wechatserver.util.StringUtils;
...
public class CustomWechat extends WechatSupport {
    private static Logger logger = LogManager.getLogger();
    public CustomWechat(HttpServletRequest request) {
        super(request);
    }
    ...
    protected void onText() {
        String content = super.wechatRequest.getContent();
...
//    }
    ...
    protected void picPhotoOrAlbum() {
        String Count = wechatRequest.getSendPicsInfo().getCount();
        String PicMd5Sum = "";
        if(!StringUtils.isNull(Count) && !Count.equals("0")){
